...
[~, roi_volume] = your_nifti_read_function(path_to_roi_mask);
...
% --- Finalize Parcel Labels ---
% To ensure parcel labels are unique across hemispheres (e.g., Left: 1,2,3
% and Right: 4,5,6), we offset the labels for the right hemisphere.
parcel